    ...
    try {
      ...
      for (const [id, value] of Object.entries(raw)) {
        ...
        profiles.set(id, {
          ...
          // A profile written before brooms existed owns none, which
          // `bestOwnedBroom` resolves to the free starter rather than to
          // nothing at all.
          ownedBrooms: numeric(value.ownedBrooms),
