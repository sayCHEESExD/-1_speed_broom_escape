import { canRebirth, maxLevelForRebirth, nextRebirthTier, rebirthMultiplier } from '@broom/shared';
 ...
 * earned OUTSIDE that curve: Wins, owned brooms and owned trails are
...
export class RebirthService {
   ...
   * the multiplier, and deliberately leaves Wins, brooms and trails alone.
   */
