 ...
 *
 * "Speed" is the progression currency. Players farm it by riding - every
 * stride the broom takes and every jump it makes adds to a lifetime total,
 * and crossing a level threshold makes the player permanently faster, which is
 * what opens the later stages' gaps.
 *
...
export interface SpeedConfig {
  ...
  /** Strides' worth of Speed granted each time the broom leaves the ground. */
