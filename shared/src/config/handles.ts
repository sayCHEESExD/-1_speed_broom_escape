...
/**
 * Noun half, drawn from the game's own brooms and its verbs.
 *
 * SIXTEEN of them, exactly as many as `FIRST` - the tag that keeps two Swift
 * Bristles apart is four hex digits, and the pool size is what decides how
 ...
 */
const SECOND = [
  'Bristle', 'Broom', 'Rider', 'Besom', 'Comet', 'Bolt', 'Dash', 'Glide',
  'Soar', 'Trail', 'Sprint', 'Flyer', 'Racer', 'Charger', 'Spell', 'Rune',
] as const;
