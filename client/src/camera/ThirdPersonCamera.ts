import { CAMERA } from '@broom/shared';
 ...
 * camera that trails the character's facing means pressing A turns the broom,
 ...
 * source of "which way is forward" and the broom's facing follows where it is
 * actually going.
 *
