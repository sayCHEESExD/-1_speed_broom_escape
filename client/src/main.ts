...
const main = async (): Promise<void> => {
  ...
  if (clientConfig.debug) {
    ...
    (window as Window & { __broom?: DebugHandle }).__broom = { game, loop };
  }

  // Hidden only on a REAL join. Speed, levels, Wins and brooms are all
