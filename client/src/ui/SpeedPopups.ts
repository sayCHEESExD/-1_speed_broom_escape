import { formatSpeed } from '@broom/shared';
...
export class SpeedPopups {
  ...
  constructor(parent: HTMLElement) {
    ...
    for (let i = 0; i < POOL_SIZE; i += 1) {
      ...
      node.innerHTML =
        /*
         * The trail icon, not a running shoe.
         *
         * The previous game had a `run.png` for this and this one's asset set
         * does not - there are three supplied icons here, not four. Trail is
         * the right one of the three to borrow: the popup is a Speed gain, and
         * a trail is the thing in this game that multiplies movement speed.
         * Using trophy would have said "you won a stage", which is a different
         * event with its own effect already.
         */
        '<img class="aoe-pop__icon" src="/ui/trail.png" alt="" draggable="false">' +
